...
-- Iglesias (Congregaciones oficiales asociadas a sus distritos)
...
(3, 'Iglesia Central Florencia'),
(3, 'Iglesia Jerusalén Florencia'),
(3, 'Grupo Canaán Yurayaco'),
(3, 'Iglesia Esmirna Curillo'),
(3, 'Iglesia Belén'),
(3, 'Grupo Renacer la Gloria'),
(3, 'Iglesia Efeso Ceilan'),
(3, 'Iglesia Filadelfia'),
(4, 'Iglesia Nuevo Amanecer'),
(4, 'Iglesia Orión Florencia'),
(4, 'Grupo Nazareth Florencia'),
(4, 'Grupo Sinaí Solano'),
(4, 'Grupo Lirios'),
(4, 'Iglesia Olivos'),
(4, 'Grupo Luz Celestial'),
(4, 'Grupo Paraiso San Antonio'),
(5, 'Iglesia Nuevo Amanecer Redención'),
(5, 'Iglesia Orión Florencia Redención'),
(5, 'Grupo Nazareth Redención'),
(5, 'Grupo Sinaí Redención'),
(6, 'Iglesia Renacer Garzón'),
(6, 'Iglesia Gigantes de la Fe'),
(6, 'Grupo Eben Ezer Suaza'),
(6, 'Iglesia Horeb Zuluaga'),
(6, 'Iglesia Sion Silvania'),
(6, 'Grupo Jerusalen Guadalupe'),
(6, 'Grupo Nueva Esperanza Garzón'),
(7, 'Iglesia Edén La Plata'),
(7, 'Iglesia Getsemaní Getzem'),
(7, 'Iglesia Maranatha Agrado'),
(7, 'Grupo Elohim Paicol'),
(7, 'Grupo Tesalia'),
...
(8, 'Grupo Orión Neiva'),
(9, 'Iglesia Jardín'),
(9, 'Iglesia Nueva Jerusalén'),
(9, 'Iglesia Fuente de Vida (Vegalarga)'),
(9, 'Grupo Siervos de Dios'),
(9, 'Iglesia Luz de Oriente'),
(10, 'Iglesia Manantial Neiva'),
(10, 'Iglesia Bethel Río Chiquito'),
(10, 'Iglesia Edén Neiva'),
(10, 'Iglesia Filadelfia Neiva'),
(10, 'Grupo Renacer Caguán'),
(11, 'Iglesia Pitalito Central'),
(11, 'Iglesia Acevedo'),
(11, 'Grupo Maito'),
(11, 'Grupo Timaná San Antonio'),
(11, 'Iglesia Esperanza Marimba'),
(12, 'Iglesia Nuevo Edén'),
(12, 'Iglesia Maranatha Criollo'),
(12, 'Iglesia Palestina Pitalito'),
(12, 'Iglesia Remanente Isnos'),
(12, 'Iglesia Paraíso Pitalito'),
(12, 'Grupo Emanuel Bordones'),
(12, 'Grupo Jerusalén Bruselas'),
(13, 'Iglesia Horeb Puerto Rico'),
(13, 'Iglesia Emmanuel Puerto Rico'),
(13, 'Iglesia Gilgal Doncello'),
(13, 'Iglesia Edén Doncello'),
(13, 'Iglesia Fuente Vida - La Granada'),
(13, 'Iglesia Bethel Guacamayas'),
(13, 'Grupo Paraíso las Palmas'),
(14, 'Iglesia Sión San Vicente'),
(14, 'Iglesia Manantial Campo Hermoso'),
(14, 'Iglesia La Victoria San Vicente'),
(14, 'Iglesia Bethel Macarena'),
(14, 'Iglesia Sinaí la Novia'),
(14, 'Iglesia Renacer la Cristalina'),
(14, 'Grupo Remanente San Juan'),
(14, 'Grupo Luz de Esperanza Tailandia'),
(14, 'Grupo Rayo de Luz'),
(14, 'Iglesia Maranatha Las Damas');
